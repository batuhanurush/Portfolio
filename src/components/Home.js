  ...
  return (
    <Container>
      <Introduction>
        ...
        <div className="short">
        Software tester who likes to tinker with software :).
        </div>
        ...
        <Social>
          <div className="iconcontainer">
            <a
              className="same"
              href="https://github.com/batuhanurush/"
              target="_blank"
          ...
          <div className="iconcontainer">
            <a
              className="same"
              href="https://www.linkedin.com/in/batuhanurush/"
              target="_blank"
              rel="noopener noreferrer"
              title="Look through my Github profile"
            >
          ...
          <div className="iconcontainer">
            <a
              className="same"
              href="mailto:batuhanurush@gmail.com"
              target="_blank"
              rel="noopener noreferrer"
              title="Look through my Github profile"
            >
